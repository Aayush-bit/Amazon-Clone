        ...
        <div className="home">
            ...
            <div className="home__rows">
                <div className="home__row">
                    ...
                    price = {20}
                    rating = {4}
                    productImage = "https://m.media-amazon.com/images/I/61sw43+4gRL._AC_UL480_FMwebp_QL65_.jpg"
                    />
                    <Product 
                    ...
                    price = {25}
                    rating = {5}
                    productImage = "https://m.media-amazon.com/images/I/61O2psKTPKL._AC_UL480_FMwebp_QL65_.jpg"
                    />
                    {/* <Product /> */}
                </div>
                <div className="home__row">
                    ...
                    price = {19}
                    rating = {5}
                    productImage = "https://m.media-amazon.com/images/I/71xy9r8YwiL._AC_UY327_FMwebp_QL65_.jpg"
                    />
                    <Product 
                    ...
                    price = {19}
                    rating = {4}
                    productImage = "https://m.media-amazon.com/images/I/61e70BcJWPL._AC_UL480_FMwebp_QL65_.jpg"
                    />
                    <Product 
                    title = "Bhagavad-gita As It Is | By - A. C. Bhaktivedanta Swami Prabhupāda"
                    price = {9.99}
                    rating = {5}
                    productImage = "https://m.media-amazon.com/images/I/81HR0LQ5ZmL._AC_UY327_FMwebp_QL65_.jpg"
                    />
                </div>
                <div className="home__row">
                    <Product 
                    ...
                    price = {19.99}
                    rating = {4}
                    productImage = "https://m.media-amazon.com/images/I/31bo-j4ic+L._AC_UL480_FMwebp_QL65_.jpg"
                    />
                    <Product 
                    title = "VRINDAVANBAZAAR.COM Radha Krishna Soft and Cute Washable Toys; Height 6 inch"
                    price = {19.59}
                    rating = {5}
                    productImage = "https://m.media-amazon.com/images/I/71uDQjTgXCL._AC_UL480_FMwebp_QL65_.jpg"
                    />
                    <Product 
                    title = "VRINDAVANBAZAAR.COM Nand Baba and Yashoda MATA with Krishna Balaram Soft Toy; Height 7.5 inch"
                    price = {29.59}
                    rating = {5}
                    productImage = "https://m.media-amazon.com/images/I/71w26W89mhL._AC_UL480_FMwebp_QL65_.jpg"
                    />
                    <Product 
                    title = "VRINDAVANBAZAAR.COM Radha Krishna Doll with 2 Cows Soft Toys; Height 6 inch"
                    price = {21.59}
                    rating = {5}
                    productImage = "https://m.media-amazon.com/images/I/91qDLzl7D2L._AC_UL480_FMwebp_QL65_.jpg"
                    />
                </div>
            </div>
        </div>
